...
import cn.org.july.web.system.dao.SysMenuDao;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenusByUser(SysUser user) {
        ...
        if (user.isAdmin()) {
            ...
            menus = menuDao.selectMenusByUserId(user.getUserId());
        }
    ...
    public LinkedHashMap<String, String> selectPermsAll() {
        ...
        List<SysMenu> permissions = menuDao.selectMenuAll();
    ...
    public String checkMenuNameUnique(SysMenu menu) {
        ...
        SysMenu info = menuDao.checkMenuNameUnique(menu.getMenuName(), menu.getParentId());
