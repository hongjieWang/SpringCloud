...
import cn.org.july.web.system.dao.SysRoleDao;
import cn.org.july.web.system.dao.SysRoleDeptDao;
import cn.org.july.web.system.dao.SysRoleMenuDao;
import cn.org.july.web.system.dao.SysUserRoleDao;
import cn.org.july.web.system.entitis.SysRole;
import cn.org.july.web.system.entitis.SysRoleDept;
import cn.org.july.web.system.entitis.SysRoleMenu;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public boolean deleteRoleById(Long roleId) {
        return roleDao.deleteRoleById(roleId) > 0 ? true : false;
    }
    ...
    public int insertRoleDept(SysRole role) {
        ...
        if (list.size() > 0) {
            rows = roleDeptDao.batchRoleDept(list);
        }
        return rows;
    }
    ...
    public String checkRoleNameUnique(SysRole role) {
        ...
        SysRole info = roleDao.checkRoleNameUnique(role.getRoleName());
    ...
    public String checkRoleKeyUnique(SysRole role) {
        Long roleId = StringUtils.isNull(role.getRoleId()) ? -1L : role.getRoleId();
        SysRole info = roleDao.checkRoleKeyUnique(role.getRoleKey());
        if (StringUtils.isNotNull(info) && info.getRoleId().longValue() != roleId.longValue()) {
