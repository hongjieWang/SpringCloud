...
public class CompactAlgorithm {
    ...
    public static void main(String[] args) {
        File f = new File("C:\\Users\\goodboy\\files\\5ec4944b-0352-4394-8b27-a69458f300af");
        new CompactAlgorithm(new File("C:\\Users\\goodboy\\files\\", f.getName() + ".zip")).zipFiles(f);
    }
